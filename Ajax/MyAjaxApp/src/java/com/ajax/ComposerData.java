...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "John Seba", "Lilly", "Baroque"));
        ...
        composers.put("16", new Composer("16", "Lehola", "Thabelang", "Classical"));
        ...
        composers.put("22", new Composer("22", "Masilo", "Tefo", "Rapelang"));
        ...
        composers.put("26", new Composer("26", "Reitumetse", "Paleho", "Romantic"));
